...
# --- INICIO DEL RETO (FLUJO COMPLETO) ---
print("\n>>> INICIANDO PROCESO DE RESERVA...")

# Usamos el primer usuario, primera película, primera sala y primera función
u_actual = usuarios[1]
peli = peliculas[0]
sala = salas[0]
func = funciones[0]
...
# Primera selección de asientos (con asiento ocupado)
print("Seleccione sus asientos (separados por coma): A1, A2, B5")
print("\n[SISTEMA]: Verificando disponibilidad...")

# Verificar asientos ocupados usando el método de la sala
